...
* Cálculo de sugestão de investimento mensal;
* Simulação de aportes ao longo dos anos;
* Cálculo do patrimônio acumulado;
* Definição de diferentes perfis de investidor;
...
As categorias de FIIs consideradas incluem:
